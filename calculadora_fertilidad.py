...
# VERSIÓN COMPLETA, CORREGIDA Y REFACTORIZADA
...
class EvaluacionFertilidad:
    ...
    def _evaluar_factor_masculino(self):
        # ... (código original, ya era legible)
