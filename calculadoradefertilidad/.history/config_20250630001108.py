...
SIMULATABLE_VARIABLES = {
    ...
    'volumen_seminal': { 'label': "Volumen Seminal (mL)", 'type': 'slider', 'min': 0.0, 'max': 10.0, 'step': 0.1, 'format_spec': "%.1f", 'unit': ' mL' },
    'concentracion_esperm': { 'label': "Concentración Espermática (M/mL)", 'type': 'slider', 'min': 0.0, 'max': 200.0, 'step': 1.0, 'format_spec': "%.1f", 'unit': ' M/mL' },
    'motilidad_progresiva': { 'label': "Motilidad Progresiva (%)", 'type': 'slider', 'min': 0, 'max': 100, 'step': 1, 'format_spec': "%d", 'unit': '%' },
    'morfologia_normal': { 'label': "Morfología Normal (%)", 'type': 'slider', 'min': 0, 'max': 100, 'step': 1, 'format_spec': "%d", 'unit': '%' },
    'vitalidad_esperm': { 'label': "Vitalidad Espermática (%)", 'type': 'slider', 'min': 0, 'max': 100, 'step': 1, 'format_spec': "%d", 'unit': '%' }
}
...
CLINICAL_INSIGHTS = {
    ...
    "AMH_BAJA": "Una AMH baja (< 1.0 ng/mL) indica una reserva ovárica disminuida. Aunque no imposibilita el embarazo, puede reducir la ventana de oportunidad y se asocia con una probabilidad de concepción un ~23% menor en comparación con una AMH normal para la misma edad.",
