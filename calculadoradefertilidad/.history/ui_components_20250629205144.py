...
# ===================================================================
# PARTE 1: SUB-FUNCIONES MODULARES (Sin Cambios)
# ===================================================================
...
def _mostrar_historial_clinico(inputs):
    ...
    if tiene_polipo:
        inputs['tipo_polipo'] = st.selectbox("Tipo de Pólipo", ["pequeno_unico", "moderado_multiple", "grande"], key.py="polipo_type")
    else:
        inputs['tipo_polipo'] = ""
...
# ===================================================================
# PARTE 2: FUNCIÓN PRINCIPAL DEL FORMULARIO (Sin Cambios)
# ===================================================================
...
# ===================================================================
# PARTE 3: FUNCIÓN PARA MOSTRAR EL INFORME (¡MODIFICADA!)
# ===================================================================
def mostrar_informe_completo(evaluacion):
    ...
    # --- NUEVA ESTRUCTURA CON EXPANDERS ---
