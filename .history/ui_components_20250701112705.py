...
def ui_perfil_basico():
    """Dibuja la interfaz de usuario para el Paso 1: Perfil Básico."""
    st.markdown("#### Paso 1 de 4: Perfil Básico")
    st.number_input("Edad", min_value=18, max_value=55, key="edad")
    st.number_input("Duración promedio del ciclo (días)", min_value=20, max_value=90, key="duracion_ciclo")
