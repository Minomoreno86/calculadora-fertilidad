...
from db_manager import crear_conexion_y_tablas, insertar_registro
...
if 'evaluacion_actual' in st.session_state:
    ...
    if st.button("💾 Guardar este Perfil y Resultado", use_container_width=True):
        ...
        if conn is not None:
            ...
            # CORRECCIÓN: Añadimos 'mioma_submucoso_multiple' a la tupla de registro
            registro = (
                ...
                1 if evaluacion.mioma_submucoso_multiple else 0, # <-- NUEVO CAMPO AÑADIDO
