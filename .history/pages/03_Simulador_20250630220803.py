...
fig = go.Figure(data=[
    go.Bar(name='Pronóstico Original', x=['Pronóstico'], y=[pronostico_original], marker_color='royalblue'),
    go.Bar(name='Pronóstico Simulado', x=['Pronóstico'], y=[pronostico_simulado], marker_color='seagreen')
])
