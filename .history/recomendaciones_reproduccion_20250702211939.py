...
def obtener_recomendaciones(datos):
    ...
    # Coito Programado
    # ===========================
    if tiene_sop or (infertilidad_origen_desconocido and edad < 35 and trompas_permeables):
    ...
    # ===========================
    if factor_tubario or baja_reserva_ovarica or (infertilidad_origen_desconocido and edad >= 35):
        recomendaciones.append("✔️ FIV / ICSI recomendada por factor tubárico, baja reserva ovárica o infertilidad de origen desconocido en paciente ≥ 35 años.")
        tecnica_sugerida = "FIV / ICSI"
