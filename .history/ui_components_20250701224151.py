...
# --- INTERFAZ DE USUARIO ---
# (Aquí conservamos todas las funciones ui_perfil_basico, ui_historial_clinico, ui_laboratorio, ui_factor_masculino sin cambios porque ya están bien en tu archivo)
