...
LOGROS_DISPONIBLES = [
    {"nombre": "Primer Informe", "descripcion": "Genera tu primer informe de fertilidad."},
    {"nombre": "Explorador", "descripcion": "Realiza tu primera simulación."},
    {"nombre": "Planificador", "descripcion": "Guarda 3 perfiles distintos."},
    {"nombre": "Constante", "descripcion": "Registra seguimiento durante 3 meses."},
    {"nombre": "Saludable", "descripcion": "Simulas y mejoras tu IMC a rango normal."},
    {"nombre": "Experto en Fertilidad", "descripcion": "Completa todas las secciones del informe."},
    {"nombre": "Sabio", "descripcion": "Revisaste todas las recomendaciones clínicas."},
]
