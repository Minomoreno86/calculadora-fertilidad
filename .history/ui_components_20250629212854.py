...
def ui_laboratorio():
    """Crea la UI para el Paso 3 y usa st.session_state."""
    st.markdown("Resultados de análisis de sangre relevantes.")
    with st.expander("Expandir para introducir Perfil Endocrino y Metabólico"):
        ...
        # El widget TPO solo aparece si TSH es relevante, pero la clave se inicializó en app.py
        if st.session_state.get("tsh", 0) > 2.5:
        ...
        st.number_input("Glicemia en ayunas (mg/dL)", 50.0, 200.0, format="%.1f", key="glicemia_ayunas")
