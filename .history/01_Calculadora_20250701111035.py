# 01_Calculadora.py (Versión COMPLETA con Navegación Flexible)
...
# --- NUEVA LÓGICA DE NAVEGACIÓN GUIADA Y FLEXIBLE ---
pasos_totales = 4
...
if st.button("Generar Informe de Fertilidad Completo", type="primary", use_container_width=True, key="generar_informe"):
    try:
        # Tu lógica de creación del objeto 'evaluacion' se mantiene exactamente igual
