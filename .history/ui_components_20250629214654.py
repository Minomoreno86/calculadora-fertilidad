...
def ui_factor_masculino():
    ...
    st.checkbox("Incluir análisis de espermatograma en la evaluación", key="use_esperma", value=st.session_state.get("use_esperma", True))
...
def mostrar_formulario_completo():
    # Esta función ya no la estamos usando en app.py, pero la mantenemos por si la necesitamos en el futuro
    with st.sidebar:
