...
# Se ejecuta solo una vez al inicio de una nueva sesión de usuario.
...
if st.button("Generar Informe de Fertilidad Completo", type="primary", use_container_width=True):
    try:
        # La llamada completa a EvaluacionFertilidad, recogiendo todos los datos de st.session_state
    ...
    if st.button("💾 Guardar este Perfil y Resultado", use_container_width=True):
        ...
        if conn is not None:
            ...
            registro = (
                ...
                evaluacion.volumen_seminal, evaluacion.concentracion_esperm, evaluacion.motilidad_progresiva,
