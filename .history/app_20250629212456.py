...
# --- Inicialización del Session State (SECCIÓN CORREGIDA) ---
if 'step' not in st.session_state:
    ...
    # Inicializamos TODAS las sub-claves de miomas con sus valores por defecto.
...
if st.button("Generar Informe de Fertilidad (Prueba Pasos 1-2)", type="primary", use_container_width=True):
    try:
        # El resto de la lógica ya estaba bien, leerá los valores por defecto si no se cambian.
