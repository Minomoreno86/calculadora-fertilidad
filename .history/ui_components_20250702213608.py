...
# --- Factor Tubárico (HSG) ---
tiene_otb = st.selectbox("¿La paciente tiene OTB (ligadura de trompas)?", ["No", "Sí"], key="tiene_otb")
...
factor_tubario = st.toggle("¿La paciente tiene factor tubárico diagnosticado por otros métodos?", key="factor_tubario")
